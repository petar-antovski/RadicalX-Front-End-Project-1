...
export const HeroImage = () => {
  ...
  useEffect(() => {
    heroimage.trim().length !== 0 ? setHeroImageVisible(true) : setHeroImageVisible(false);
  }, [heroimage]);
    ...
    <Form>
      <div className='SettingsForm'>
        <div className='SettingsURLInput'>
          ...
          <input name='url' value = {heroimage} className='SettingsFormInput' placeholder = 'radicalx-internship-url' onChange={handleChange}/>
        </div>
