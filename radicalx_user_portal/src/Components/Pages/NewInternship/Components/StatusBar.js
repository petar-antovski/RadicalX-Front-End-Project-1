  ...
  return (
    <nav>
        <ol className="StatusBar">
          <li className={CategoryVisible && DescriptionVisible && LocationVisible && BenefitsVisible && IntroVideoVisible && MentorDetailsVisible && RecommendedRolesVisible && WebLinksResourcesVisible ? "StatusBarItemComplete" : link === "/NewInternship/InternshipDescription" ? "StatusBarItemActive" : "StatusBarItemInnactive"}>
